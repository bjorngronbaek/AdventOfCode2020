...
namespace AdventOfCode2020
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(new Challenge5().RunSecond());
            //Console.WriteLine(new Challenge6().RunFirst());
            ...
            //Console.WriteLine(new Challenge9().RunFirst());
            //Console.WriteLine(new Challenge9().RunSecond());
            //Console.WriteLine(new Challenge10().RunFirst());
            Console.WriteLine(new Challenge10().RunSecond());
        }
    }
}